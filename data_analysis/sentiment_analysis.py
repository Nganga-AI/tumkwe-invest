...
class SentimentAnalyzer:
    ...
    def analyze_sources(self, news_articles: List[Dict], social_posts: Optional[List[Dict]] = None) -> Dict[str, Any]:
        """
        ...
        for article in news_articles:
            ...
            combined_sentiment = title_result['sentiment'] if title_result['confidence'] > content_result['confidence'] else content_result['sentiment']
            ...
            article_result = {
                ...
                "confidence": (title_result['confidence'] * 0.6) + (content_result['confidence'] * 0.4)
            }
        ...
        for source in ["news", "social"]:
            for item in all_results[source]:
                sentiment_key = "combined_sentiment" if source == "news" else "sentiment"
        ...
        if total_items > 0:
            ...
            if sentiment_counts[dominant_sentiment] > 0:
                avg_confidence = weighted_scores[dominant_sentiment] / sentiment_counts[dominant_sentiment]
            
            all_results["overall"] = {
                "dominant_sentiment": dominant_sentiment,
                "confidence": avg_confidence,
                "distribution": {
                    "positive_percent": (sentiment_counts["positive"] / total_items) * 100,
                    "neutral_percent": (sentiment_counts["neutral"] / total_items) * 100,
                    "negative_percent": (sentiment_counts["negative"] / total_items) * 100
                }
            }
    ...
    def validate_accuracy(self, test_data: List[Dict[str, str]]) -> Dict[str, float]:
        ...
        confusion_matrix = {
            ...
            "true_neutral": 0, "false_neutral": 0
        }
        ...
        for sentiment in ["positive", "negative", "neutral"]:
            ...
            precision = true_pos / (true_pos + false_pos_sum) if (true_pos + false_pos_sum) > 0 else 0
