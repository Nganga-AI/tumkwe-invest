...
class TestAnalysisValidator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reference_data["MA_50"] = (
            self.price_data["close"].rolling(window=50).mean() + 0.0005
        )
        ...
        self.test_sentiment_dataset = [
            {
                "text": "The company reported great earnings this quarter.",
                "label": "positive",
            },
            {
                "text": "The stock price fell sharply after the announcement.",
                "label": "negative",
            },
            {
                "text": "The market remained stable throughout the day.",
                "label": "neutral",
            },
            {
                "text": "Investors are concerned about the company's debt.",
                "label": "negative",
            },
    ...
    def test_validate_technical_indicators(self):
        ...
        result = AnalysisValidator.validate_technical_indicators(
            self.price_data, reference_data=self.reference_data
        )
    ...
    def test_validate_sentiment_model(self):
        ...
        with patch(
            "data_analysis.sentiment_analysis.SentimentAnalyzer.validate_accuracy"
        ) as mock_validate:
            ...
            result = AnalysisValidator.validate_sentiment_model(
                self.test_sentiment_dataset, model_type="ensemble"
            )
    ...
    def test_compare_recommendations(self):
        ...
        with patch(
            "data_analysis.integrated_analysis.IntegratedAnalyzer.calculate_integrated_score"
        ) as mock_calculate:
    ...
    def test_visualize_backtest(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".png") as temp_file:
            ...
            with patch(
                "data_analysis.integrated_analysis.IntegratedAnalyzer.backtest"
            ) as mock_backtest:
