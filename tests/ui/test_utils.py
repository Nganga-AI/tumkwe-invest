...
from tumkwe_invest.ui.utils import (
    format_currency, format_number, format_percent, format_date,
    format_timeframe, truncate_text, sanitize_html, generate_color_palette,
    get_trend_color, get_contrast_text_color, simplify_large_number,
    create_theme_config, convert_to_frontend_format, AccessibilityUtils
)
...
class TestAccessibilityUtils:
    def test_get_aria_labels(self):
        ...
        # Test metric
        metric_aria = utils.get_aria_labels("metric", {"title": "Revenue", "value": "$1M"})
