...
class TestFormattingEdgeCases(unittest.TestCase):
    ...
    def test_sanitize_html_advanced(self):
        ...
        nested = "<div><script>bad()</script><p>Good</p><script>also_bad()</script></div>"
...
class TestConversionFunctions(unittest.TestCase):
    def test_convert_to_frontend_format_complex_structures(self):
        ...
        self.assertEqual(converted["nested"]["deep"]["deeper"]["deepest"], today.isoformat())
...
class TestThemeConfigFunctions(unittest.TestCase):
    def test_create_theme_config_variations(self):
        ...
        self.assertEqual(custom_theme["colors"]["background"], "#121212")  # Dark mode background
        ...
        self.assertEqual(custom_theme["colors"]["positive"], "#00C853")  # Dark mode positive
        self.assertEqual(custom_theme["colors"]["border"], "#333333")  # Dark mode border
...
class TestAccessibilityUtils(unittest.TestCase):
    ...
    def test_generate_skip_links_custom(self):
        ...
        main_links = [link for link in default_links if link["target"] == "main-content"]
        self.assertEqual(len(main_links), 1)
        
        # Check navigation link
        nav_links = [link for link in default_links if link["target"] == "main-navigation"]
