...
class TestSentimentAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.positive_text = (
            "The company reported excellent earnings, exceeding all expectations!"
        )
        self.negative_text = (
            "The stock crashed following poor management decisions and declining sales."
        )
        self.neutral_text = (
            "The market remained stable today with trading volumes at average levels."
        )
        ...
        self.test_data = [
            ...
            {
                "text": "Regulatory investigation impacts share price",
                "label": "negative",
            },
        ]
        ...
        with patch("transformers.AutoModelForSequenceClassification.from_pretrained"):
            with patch("transformers.AutoTokenizer.from_pretrained"):
                ...
                results = analyzer.analyze_sources(
                    self.news_articles, self.social_posts
                )
