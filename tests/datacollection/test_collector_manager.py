...
class TestCollectorManager(unittest.TestCase):
    ...
    def test_init_and_load_tasks(
        self, mock_file, mock_pickle_load, mock_exists, mock_makedirs
    ):
    ...
    def test_start_stop_collection_thread(
        self, mock_thread, mock_exists, mock_makedirs
    ):
    ...
    def test_get_validation_summary(
        self, mock_generate_report, mock_exists, mock_makedirs
    ):
        ...
        manager.last_validation = {"report1": MagicMock(), "report2": MagicMock()}
