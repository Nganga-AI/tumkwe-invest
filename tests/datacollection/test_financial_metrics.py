...
class TestFinancialMetrics(unittest.TestCase):
    ...
    def test_get_key_metrics_yf(self, mock_ticker_class):
        ...
        mock_income = pd.DataFrame({mock_date: {"Net Income": 30000000000.0}})
    ...
    @patch(
        "datacollection.collectors.financial_metrics.open",
        new_callable=unittest.mock.mock_open,
    )
    @patch(
        "datacollection.collectors.financial_metrics.ALPHA_VANTAGE_API_KEY", "dummy_key"
    )
    @patch("datacollection.collectors.financial_metrics.time.sleep")
    def test_get_alpha_vantage_metrics(
        self, mock_sleep, mock_file, mock_exists, mock_get
    ):
    ...
    def test_get_quarterly_financial_data(self, mock_ticker_class):
        ...
        mock_income_q = pd.DataFrame(
            {
                mock_date1: {
                    "Total Revenue": 97000000000.0,
                    "Net Income": 25000000000.0,
                },
                mock_date2: {
                    "Total Revenue": 83000000000.0,
                    "Net Income": 19000000000.0,
                },
            }
        )
        ...
        mock_balance_q = pd.DataFrame(
            {
                mock_date1: {
                    "Total Assets": 340000000000.0,
                    "Total Equity": 140000000000.0,
                },
                mock_date2: {
                    "Total Assets": 350000000000.0,
                    "Total Equity": 150000000000.0,
        ...
        mock_cashflow_q = pd.DataFrame(
            {
                mock_date1: {
                    "Operating Cash Flow": 28000000000.0,
                    "Capital Expenditure": -4000000000.0,
                },
                mock_date2: {
                    "Operating Cash Flow": 25000000000.0,
                    "Capital Expenditure": -5000000000.0,
                },
            }
        )
