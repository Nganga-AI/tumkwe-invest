...
class TestNewsCollector(unittest.TestCase):
    ...
    def test_get_company_news(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            # Call function
            result = get_company_news(company_symbol="MSFT", company_name="Microsoft", days=5, max_articles=10)
            ...
            self.assertEqual(article1.summary, "Microsoft is rolling out new features for Windows users.")
            ...
            self.assertEqual(article2.summary, "Microsoft's stock reached a new record today.")
