...
def format_percent(
    value: Union[float, int], precision: int = 2, include_sign: bool = False
) -> str:
    """
...
def get_trend_color(
    value: float, neutral_threshold: float = 0.05, theme: str = "light"
) -> str:
    """
    ...
    colors = {
        ...
        "dark": {"positive": "#00C853", "negative": "#FF5252", "neutral": "#9AA0A6"},
    }
...
def create_theme_config(
    theme_name: str, is_dark: bool = False, primary_color: str = "#4285F4"
) -> Dict[str, Any]:
    """
